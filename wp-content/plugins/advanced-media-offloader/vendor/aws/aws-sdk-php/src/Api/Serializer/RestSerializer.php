...
namespace WPFitter\Aws\Api\Serializer;

use WPFitter\Aws\Api\MapShape;
use WPFitter\Aws\Api\Service;
use WPFitter\Aws\Api\Operation;
use WPFitter\Aws\Api\Shape;
use WPFitter\Aws\Api\StructureShape;
use WPFitter\Aws\Api\TimestampShape;
use WPFitter\Aws\CommandInterface;
use WPFitter\Aws\EndpointV2\EndpointV2SerializerTrait;
...
use WPFitter\GuzzleHttp\Psr7\UriResolver;
