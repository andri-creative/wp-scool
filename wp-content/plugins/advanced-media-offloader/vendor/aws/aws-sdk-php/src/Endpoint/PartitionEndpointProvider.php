...
namespace WPFitter\Aws\Endpoint;

use WPFitter\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \WPFitter\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \WPFitter\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
