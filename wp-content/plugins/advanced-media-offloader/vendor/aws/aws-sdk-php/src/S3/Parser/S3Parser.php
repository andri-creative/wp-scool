...
namespace WPFitter\Aws\S3\Parser;

use WPFitter\Aws\Api\ErrorParser\XmlErrorParser;
use WPFitter\Aws\Api\Parser\AbstractParser;
...
use WPFitter\GuzzleHttp\Psr7\Utils;
