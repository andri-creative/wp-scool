...
namespace WPFitter\Aws\S3\RegionalEndpoint;

use WPFitter\Aws\AbstractConfigurationProvider;
use WPFitter\Aws\CacheInterface;
use WPFitter\Aws\ConfigurationProviderInterface;
use WPFitter\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \WPFitter\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
