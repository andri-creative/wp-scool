...
use WPFitter\Aws\LruArrayCache;
use WPFitter\Aws\Result;
use WPFitter\Aws\S3\Exception\S3Exception;
use WPFitter\GuzzleHttp\Psr7;
use WPFitter\GuzzleHttp\Psr7\Stream;
use WPFitter\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \WPFitter\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use ($filterFn) {
