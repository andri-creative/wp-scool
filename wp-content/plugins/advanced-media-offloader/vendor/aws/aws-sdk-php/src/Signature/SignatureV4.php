...
use WPFitter\AWS\CRT\Auth\Signable;
use WPFitter\AWS\CRT\Auth\SignatureType;
use WPFitter\AWS\CRT\Auth\SignedBodyHeaderType;
use WPFitter\AWS\CRT\Auth\Signing;
use WPFitter\AWS\CRT\Auth\SigningAlgorithm;
use WPFitter\AWS\CRT\Auth\SigningConfigAWS;
use WPFitter\AWS\CRT\Auth\StaticCredentialsProvider;
use WPFitter\AWS\CRT\HTTP\Request;
use WPFitter\Aws\Exception\CommonRuntimeException;
use WPFitter\Aws\Exception\CouldNotCreateChecksumException;
